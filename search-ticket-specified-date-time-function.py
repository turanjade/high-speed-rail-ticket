...
def hsr_ticket(chrome_option, url, date, t, data):
    #chrome_option has defined before, as well as url
    #date, t refers to the date and the time period the ticket retrieved
    #data refers to the city pair
    ### origin station is not NaN
    while True:
